...
if (
    ...
    isset($_POST["dispo"])
        ...
        $ticketsC->modifiertic($Id,$ticket);
        header("Location: ticketadd.php?id=$id_event");

}
$ticket = $ticketsC->recuperertic($Id,$id_event);
        ...
        <main class="mai">
            <form  class="forum" action="" method="POST" >
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="Title" name="prix" value="<?php echo $ticket['prix_ticket']; ?>">
                </div>
                <div class="form-group">
                  <label for="Title">disponibilite</label>
                  <input type="text" id="Title" name="dispo" value="<?php echo $ticket['disponibilite']; ?>">
                </div>
