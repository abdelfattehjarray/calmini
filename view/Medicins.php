          ...
          <nav class="navbar navbar-expand-sm bg-white navbar-light py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
              <ul class="navbar-nav ms-5 py-0">
                ...
                <li class="nav-item">
                  <a href="Medicins.php" class="nav-link active">Medicins</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center mx-auto mb-5" style="max-width: 500px;">
                <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5">Trouver un médecin</h5>
                ...
                <div class="col-lg-6 team-item">
                    <div class="row g-0 bg-light rounded overflow-hidden">
                        <div class="col-12 col-sm-5 h-100">
                            <img class="img-fluid h-100" src="../img/<?= $listCoachs[$i]["image"]; ?>" style="object-fit: cover;">
                        </div>
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                            <div class="mt-auto p-4">
                                <h3> <?= $listCoachs[$i]["idCoach"]; ?></h3>
                                <h3> <?= $listCoachs[$i]["nomCoach"]; ?></h3>
                                <h3> <?= $listCoachs[$i]["prenomCoach"]; ?></h3>
                                <h3><?= $listCoachs[$i]["tel"]; ?> </h3>
                                <h3> <?= $listCoachs[$i]["mail"]; ?> </h3>
                                 <h3>   <?= $listCoachs[$i]["experience"]; ?></h3>
                                <h6 class="fw-normal fst-italic text-primary mb-4"> <?= $listCoachs[$i]["specialite"]; ?></h6>
                               
                               
                               
                                
                                <p class="m-0"><?= $listCoachs[$i]["details"]; ?></p>
                            </div>
                            <div class="d-flex mt-auto border-top p-4">
                                <a class="btn btn-lg btn-primary btn-lg-square rounded-circle me-3" href="#"><i class="fab fa-twitter">Medecins</i></a>
                    ...
                    <a href="addUser.php" >Donner un avis</a>
                </div>
