    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-8">
                <!-- Blog Detail Start -->
                <div class="mb-5">
                    <img class="img-fluid w-100 rounded mb-5" src="data:<?php echo $Article['image_type']; ?>;base64,<?php echo base64_encode($Article['image_data']); ?>" alt="">
                    <h1 class="mb-4"><?php echo $Article['Title']; ?></h1>
                    <p><?php echo $Article['content']; ?></p>
                    <div class="d-flex justify-content-between bg-light rounded p-4 mt-4 mb-4">
                        <div class="d-flex align-items-center">
                            <img class="rounded-circle me-2" src="data:<?php echo $Article['image_type']; ?>;base64,<?php echo base64_encode($Article['image_data']); ?>" width="40" height="40" alt="">
    ...
    if ($comment_score['compound'] < -0.4767) {
        ...
        <div class="d-flex mb-4">
            ...
            <div class="ps-3">
                ...
                <a class="btn btn-sm btn-light" name="modifier" href="ArticleDetailClientCommentMod.php?IdArticle=<?php echo $commenter['IdArticle']; ?>&IdCommenter=<?php echo $commenter['IdCommenter']; ?>">Modifier</a>
                <a class="btn btn-sm btn-light" name="supprimer" href="ArticleDetailClientCommentSupp.php?IdArticle=<?php echo $commenter['IdArticle']; ?>&IdCommenter=<?php echo $commenter['IdCommenter']; ?>">Supprimer</a>
                ...
                <div class="bg-light rounded p-5">
                    ...
                    <form class="" id="myform" method="POST" >
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <textarea class="form-control bg-white border-0" rows="5" id="commenter" name="comment" placeholder="Comment"><?php echo $commenter['comment'];?></textarea>
