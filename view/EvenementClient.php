          ...
          <nav class="navbar navbar-expand-sm bg-white navbar-light py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
              <ul class="navbar-nav ms-5 py-0">
                ...
                <li class="nav-item">
                    <a href="EvenementClient.php" class="nav-link active">Evenement</a>
                </li>
                <li class="nav-item">
                ...
                <div class="col-lg-4 team-item mb-4">
                    ...
                    <div class="row g-0 bg-light rounded overflow-hidden">
                        ...
                        <div class="col-12 col-sm-5 h-100">
                            <img class="img-fluid h-100"  src="../img/<?php echo $evenement['Image']; ?>" style="object-fit: cover;">
                        </div>
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                            <div class="mt-auto p-4">
                            <h3>Nom du Evenement</h3>
                                <h6 class="fw-normal fst-italic text-primary mb-4"><?php echo $evenement['Title']; ?></h6>
                                <p class="m-0"><?php echo $evenement['Organisateurs']; ?></p>
                            </div>
                            <div class="d-flex mt-auto border-top p-4">
                                <a class="btn btn-lg btn-primary btn-lg-square rounded-circle me-3" href="ticketClient.php?id=<?php echo $evenement['Id_event']; ?>">more</a>
