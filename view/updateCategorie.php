...
if (
    ...
    isset($_POST["Img_categorie"])
        ...
        $CategorieC->modifierCategorie($IdCategorie,$Categorie);
        ...
        <main class="mai">
            <form  class="forum" action="" method="POST" >
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="Title" name="Nom_categorie" value="<?php echo $Categorie['Nom_categorie']; ?>">
                </div>
                <div class="form-group">
                  <label for="content">Description</label>
                  <textarea id="content" name="Description" ><?php echo $Categorie['Description']; ?></textarea>
                </div>                 
                <div class="form-group">
                  <label for="image">Image</label>
                  <input type="text" id="Img_categorie" name="Img_categorie" value="<?php echo $Categorie['Img_categorie']; ?>">
                </div>
