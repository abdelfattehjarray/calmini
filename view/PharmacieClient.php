...
/////////Search Form
$sqlSearch="SELECT * FROM categorie LIMIT $start_from, $per_page_record";
$listeCategorie = $CategorieC->paginationLIMIT($sqlSearch);


////////////COUNTER
$sql = "SELECT COUNT(*) FROM categorie";
$total_recordse=$CategorieC->paginationCOUNTER($sql); 
...
<body>
          ...
          <nav class="navbar navbar-expand-sm bg-white navbar-light py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
              <ul class="navbar-nav ms-5 py-0">
                ...
                <li class="nav-item">
                    <a href="PharmacieClient.php" class="nav-link active">Pharmacie</a>
                  </li>
                <li class="nav-item">
                ...
                <div class="col-lg-4 team-item mb-4">
                    <div class="row g-0 bg-light rounded overflow-hidden">
                        <div class="col-12 col-sm-5 h-100">
                            <img class="img-fluid h-100"  src="../img/<?php echo $Categorie['Img_categorie']; ?>" style="object-fit: cover;">
                        </div>
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                            <div class="mt-auto p-4">
                                <h3>Nom du Categorie</h3> 
                                <h6 class="fw-normal fst-italic text-primary mb-4"><?php echo $Categorie['Nom_categorie']; ?></h6>
                                <p class="m-0"><?php echo $Categorie['Description']; ?></p>
                            </div>
                            <div class="d-flex mt-auto border-top p-4">
                                <a class="btn btn-lg btn-primary btn-lg-square rounded-circle me-3" href="medicamentClient.php?id=<?php echo $Categorie['Id_categorie']; ?>"><i  class='bi bi-three-dots' ></i></a>
 ...
 <div class="pagination" style="padding-left:40%;">    
      <?php      
        $total_records =$CategorieC->paginationCOUNTER($sql);      
    ...
    echo "</br>";     
        ...
        if($page>=2){   
            echo "<a href='PharmacieClient.php?page=".($page-1)."'>  Prev </a>";   
        }       
                   
        for ($i=1; $i<=$total_pages; $i++) {   
          if ($i == $page) {   
              $pagLink .= "<a class = 'active' href='PharmacieClient.php?page="  
                                                .$i."'>".$i." </a>";   
          }               
          else  {   
              $pagLink .= "<a href='PharmacieClient.php?page=".$i."'>   
                                                ".$i." </a>";     
          }   
        };     
        echo $pagLink;   
        ...
        if($page<$total_pages){   
            echo "<a href='PharmacieClient.php?page=".($page+1)."'>  Next </a>";   
        }   
