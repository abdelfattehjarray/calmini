...
<body>
  ...
  foreach ($listeticketss as $tickets) {
   ?>
                <div class="col-lg-4 team-item mb-4">
                    <div class="row g-0 bg-light rounded overflow-hidden">
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                            <div class="mt-auto p-4">
                            <p class="m-0">  ID TICKET : <?php echo $tickets['Id_ticket']; ?></p>
                                <h6 class="fw-normal fst-italic text-primary mb-4"> PRIX :<?php echo $tickets['prix_ticket']; ?></h6>
                                <p class="m-0">Disponibilite : <?php echo $tickets['disponibilite']; ?></p>
                            </div>
