...
// Requête SQL pour sélectionner les rendez-vous du client connecté avec les noms de docteurs correspondants
...
foreach($result as $row)
{
    $data[] = array(
        ...
        'title' => $row["nomcoach"] // Ajouter le nom de docteur à la variable $data
    );
}
